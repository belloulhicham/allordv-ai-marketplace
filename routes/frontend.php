...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('save-recently-viewed/{serviceId}',[FrontendApp\Http\Controllers\SettingController::class,'recentlyViewedStore' ])->name('save-recently-viewed');
    Route::get('get-recently-viewed',[FrontendApp\Http\Controllers\SettingController::class,'recentlyViewedGet' ])->name('get-recently-viewed');
});
