...
Route::group(['middleware' => ['auth', 'verified']], function () {
    ...
    Route::get('comission/{id}', [App\Http\Controllers\SettingController::class, 'comission'])->name('setting.comission');
    Route::get('details/{id}', [BookingController::class, 'bookingDetailsData'])->name('booking.detailsdata');


    // Setting
    Route::get('setting/{page?}', [App\Http\Controllers\SettingController::class, 'settings'])->name('setting.index');
    Route::post('/layout-page', [App\Http\Controllers\SettingController::class, 'layoutPage'])->name('layout_page');



    // Route::post('settings/save',[ App\Http\Controllers\SettingController::class , 'settingsUpdates'])->name('settingsUpdates');
    // Route::post('dashboard-setting',[ App\Http\Controllers\SettingController::class , 'dashboardtogglesetting'])->name('togglesetting');
    // Route::post('provider-dashboard-setting',[ App\Http\Controllers\SettingController::class , 'providerdashboardtogglesetting'])->name('providertogglesetting');
    // Route::post('handyman-dashboard-setting',[ App\Http\Controllers\SettingController::class , 'handymandashboardtogglesetting'])->name('handymantogglesetting');
    // Route::post('config-save',[ App\Http\Controllers\SettingController::class , 'configUpdate'])->name('configUpdate');


    Route::post('env-setting', [App\Http\Controllers\SettingController::class, 'envChanges'])->name('envSetting');
    Route::post('update-profile', [App\Http\Controllers\SettingController::class, 'updateProfile'])->name('updateProfile');
    Route::post('change-password', [App\Http\Controllers\SettingController::class, 'changePassword'])->name('changePassword');


    //Frontend Setting

    Route::middleware(['auth', 'role:admin|demo_admin'])->group(function () {
        Route::get('frontend-setting/{page?}', [FrontendApp\Http\Controllers\SettingController::class, 'frontendSettings'])->name('frontend_setting.index');
        Route::post('/layout-frontend-page', [FrontendApp\Http\Controllers\SettingController::class, 'layoutPage'])->name('layout_frontend_page');
        Route::post('/landing-page-settings-updates', [FrontendApp\Http\Controllers\SettingController::class, 'landingpagesettingsUpdates'])->name('landing_page_settings_updates');
        Route::post('/landing-layout-page', [FrontendApp\Http\Controllers\SettingController::class, 'landingLayoutPage'])->name('landing_layout_page');
        Route::post('/get-landing-layout-page-config', [FrontendApp\Http\Controllers\SettingController::class, 'getLandingLayoutPageConfig'])->name('getLandingLayoutPageConfig');
        Route::post('/header-page-settings', [FrontendApp\Http\Controllers\SettingController::class, 'headingpagesettings'])->name('heading_page_settings');
        Route::post('/footer-page-settings', [FrontendApp\Http\Controllers\SettingController::class, 'footerpagesettings'])->name('footer_page_settings');
        Route::post('/login-register-page-settings', [FrontendApp\Http\Controllers\SettingController::class, 'loginregisterpagesettings'])->name('login_register_page_settings');
    });
    ...
    Route::group(['middleware' => ['permission:terms condition']], function () {
        Route::get('pages/term-condition', [App\Http\Controllers\SettingController::class, 'termAndCondition'])->name('term-condition');
        Route::post('term-condition-save', [App\Http\Controllers\SettingController::class, 'saveTermAndCondition'])->name('term-condition-save');
    });

    Route::group(['middleware' => ['permission:privacy policy']], function () {
        Route::get('pages/privacy-policy', [App\Http\Controllers\SettingController::class, 'privacyPolicy'])->name('privacy-policy');
        Route::post('privacy-policy-save', [App\Http\Controllers\SettingController::class, 'savePrivacyPolicy'])->name('privacy-policy-save');
    });

    Route::get('pages/about-us', [App\Http\Controllers\SettingController::class, 'aboutUs'])->name('about-us');
    Route::post('about-us-save', [App\Http\Controllers\SettingController::class, 'saveAboutUs'])->name('about-us-save');

    Route::get('pages/data-deletion-request', [App\Http\Controllers\SettingController::class, 'dataDeletion'])->name('data-deletion-request');
    Route::post('data-deletion-request-save', [App\Http\Controllers\SettingController::class, 'saveDataDeletion'])->name('data-deletion-request-save');

    Route::get('pages/help-support', [App\Http\Controllers\SettingController::class, 'helpAndSupport'])->name('help-support');
    Route::post('help-support-save', [App\Http\Controllers\SettingController::class, 'saveHelpAndSupport'])->name('help-support-save');

    Route::get('pages/refund-cancellation-policy', [App\Http\Controllers\SettingController::class, 'refundCancellationPolicy'])->name('refund-cancellation-policy');
    Route::post('refund-cancellation-policy-save', [App\Http\Controllers\SettingController::class, 'saveRefundCancellationPolicy'])->name('refund-cancellation-policy-save');

    Route::post('general-setting-save', [App\Http\Controllers\SettingController::class, 'generalSetting'])->name('generalsetting');
    Route::post('theme-setup-save', [App\Http\Controllers\SettingController::class, 'themeSetup'])->name('themesetup');
    Route::post('site-setup-save', [App\Http\Controllers\SettingController::class, 'siteSetup'])->name('sitesetup');
    Route::post('service-config-save', [App\Http\Controllers\SettingController::class, 'serviceConfig'])->name('serviceConfig');
    Route::post('promotion-config-save', [App\Http\Controllers\SettingController::class, 'promotionConfig'])->name('promotionConfig');
    Route::post('social-media-save', [App\Http\Controllers\SettingController::class, 'socialMedia'])->name('socialMedia');
    route::post('role-permission', [RoleController::class, 'rolePermission'])->name('role_layout_page');
    Route::post('cookie-setup-save', [App\Http\Controllers\SettingController::class, 'cookieSetup'])->name('cookiesetup');
    ...
    Route::post('sidebar-reorder-save', [App\Http\Controllers\SettingController::class, 'sequenceSave'])->name('reorderSave');
    ...
    Route::match(['get', 'post'], '/push-notification', [App\Http\Controllers\SettingController::class, 'PushNotification'])->name('pushNotification.index');
    Route::post('send-push-notification', [App\Http\Controllers\SettingController::class, 'sendPushNotification'])->name('sendPushNotification');
    Route::post('save-earning-setting', [App\Http\Controllers\SettingController::class, 'saveEarningTypeSetting'])->name('saveEarningTypeSetting');
    Route::post('save-userdashboard-setting', [App\Http\Controllers\SettingController::class, 'saveUserDashboardTypeSetting'])->name('saveUserDashboardTypeSetting');
    // Route::post('advance-earning-setting' , [ App\Http\Controllers\SettingController::class , 'advanceEarningSetting'])->name('advanceEarningSetting');
    Route::post('other-setting', [App\Http\Controllers\SettingController::class, 'otherSetting'])->name('otherSetting');

    // Route::post('enable-user-wallet', [App\Http\Controllers\SettingController::class, 'enableUserWallet'])->name('enableUserWallet');
...
// Routes publiques - Chat IA
Route::get('/chat', [ChatController::class, 'index'])->name('chat.index');
Route::post('/chat/send', [ChatController::class, 'demoChat'])->name('chat.send');

// Routes avec authentification client
Route::middleware(['auth'])->group(function () {
    Route::post('/chat/message', [ChatController::class, 'chat'])->name('chat.message');
    Route::get('/chat/agent/{id}', [ChatController::class, 'getAgent'])->name('chat.agent');
});
Route::get('/ai-agents-test', function () { return view('ai-agents-test'); });
Route::get('/api-docs', function () { return view('api-docs'); });
