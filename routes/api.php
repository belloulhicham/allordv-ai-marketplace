...
Route::get('landing-page-list', [API\FrontendApp\Http\Controllers\SettingController::class, 'getLandingPageSetting']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('get-recently-viewed', [App\Http\Controllers\FrontendApp\Http\Controllers\SettingController::class, 'recentlyViewedGet']);
    ...
    Route::get('payment-gateway-list', [API\FrontendApp\Http\Controllers\SettingController::class, 'getPaymentGatewayList']);
...
// API Agents IA
Route::get('ai-agents', [App\Http\Controllers\Api\AIAgentController::class, 'index']);
Route::post('ai-agents/chat', [App\Http\Controllers\Api\AIAgentController::class, 'chat']);

Route::get('test', function() {
    return response()->json(['status' => 'ok', 'message' => 'API fonctionnelle']);
});
