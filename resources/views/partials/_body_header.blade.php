                    ...
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="#" class="nav-item nav-icon dropdown-toggle search-toggle" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                @else
                                    <img src="/images/default-user.png" class="img-fluid avatar-rounded bg-light" alt="user">
                                @endauth
                                ...
                                @else
                                    <span class="mb-0 user-name">Visiteur</span>
                                @endauth
                            </a>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dropdown shadow" aria-labelledby="dropdownMenuButton">
                                ...
                                <li class="dropdown-item d-flex svg-icon">
                                    <svg class="svg-icon me-0 text-secondary" width="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
